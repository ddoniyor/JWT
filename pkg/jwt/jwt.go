...
func Encode(payload interface{}, secret Secret) (token string, err error) {
	...
	if err != nil {
		return "", errors.New("can't marshal payload")
	}
...
func Decode(token string, payload interface{}) (err error) {
	...
	if err != nil {
		return errors.New("can't unmarshal payload")
	}
...
func calculateSignatureEncoded(headerEncoded string, payloadEncoded string, secret Secret) string {
